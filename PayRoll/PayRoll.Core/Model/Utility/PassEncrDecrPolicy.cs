...
{
    internal class PassEncrDecrPolicy
    {
        ...
        private string AppPassword2 = "12340555";

        private static PassEncrDecrPolicy thisInstance = new PassEncrDecrPolicy();
        //private readonly PMS_PassEncrypt.PMS_PEncrypt SecurityDll = new PMS_PassEncrypt.PMS_PEncrypt();

        private PassEncrDecrPolicy()
        {
        }

        public static PassEncrDecrPolicy GetInstance()
        {
            return thisInstance;
        }
        ...
        private string PMS_GenPassServer(string fpass, string AppPass)
        {
